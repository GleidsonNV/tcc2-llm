...
export async function POST(req: Request) {
  ...
  try {
    const extractProblem = await generateObject({
      ...
      schemaDescription: "an object to capture a problem from user input and its reason"
    });
    ...
    const { object } = await generateObject({
      ...
      schemaDescription: "an object to capture whether the a problem was identified or not and its reason"
    });
    ...
    const problemDomain = await generateObject({
      ...
      schemaDescription: "an object to capture in what business area the user problem is in"
    });
    ...
    const problemKnowledge = await generateObject({
      ...
      schemaDescription: "general and specific knowledge about the domain, what challenges it faces, what is the current state of the domain, what is the best practices, what is aleady common ground"
    });
    ...
    do {
      ...
      schemaDescription: "an object to capture whether the generated requirements are appropriate, complete, conforming, correct, feasible, necessary, singular, unambiguous and verifiable"
      });
